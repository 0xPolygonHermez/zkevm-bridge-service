...
func (_m *StorageCompressedInterface) GetClaimTxsByStatus(ctx context.Context, statuses []types.MonitoredTxStatus, dbTx pgx.Tx) ([]types.MonitoredTx, error) {
...
//   - dbTx pgx.Tx
func (_e *StorageCompressedInterface_Expecter) GetClaimTxsByStatus(ctx interface{}, statuses interface{}, dbTx interface{}) *StorageCompressedInterface_GetClaimTxsByStatus_Call {
	return &StorageCompressedInterface_GetClaimTxsByStatus_Call{Call: _e.mock.On("GetClaimTxsByStatus", ctx, statuses, dbTx)}
}

func (_c *StorageCompressedInterface_GetClaimTxsByStatus_Call) Run(run func(ctx context.Context, statuses []types.MonitoredTxStatus, dbTx pgx.Tx)) *StorageCompressedInterface_GetClaimTxsByStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageCompressedInterface_GetClaimTxsByStatus_Call) RunAndReturn(run func(context.Context, []types.MonitoredTxStatus, pgx.Tx) ([]types.MonitoredTx, error)) *StorageCompressedInterface_GetClaimTxsByStatus_Call {
	_c.Call.Return(run)
	return _c
}
