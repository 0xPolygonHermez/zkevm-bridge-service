...
RUN := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEDBCORE) $(DOCKERCOMPOSEDBBRIDGE) && sleep 5 && sleep 5 && $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSENETWORK) && $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEBRIDGE) && sleep 5 && $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEHERMEZCORE) $(DOCKERCOMPOSEPROVER)
